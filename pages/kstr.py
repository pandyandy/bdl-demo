...
from kbcstorage.client import Client, Files, Jobs
...
class KeboolaStreamlit:
    ...
    def create_event(self, message: str = 'Streamlit App Create Event', endpoint: str = '/v2/storage/events', data: Optional[str] = None, jobId: Optional[int] = None):
        """
    ...
    def get_job_id(self, table_id: str, operation_name: str):
    ...
    def read_table(self, table_id: str) -> pd.DataFrame:
        ...
        try:
            ...
            with open(exported_file_path, mode='rt', encoding='utf-8') as in_file:
            ...
            event_job_id = self.get_job_id(table_id=table_id, operation_name='tableExport')
            self.create_event(
                jobId=event_job_id, 
                message='Streamlit App Read Table', 
                endpoint='/v2/storage/tables/table_id/export-async'
            )
